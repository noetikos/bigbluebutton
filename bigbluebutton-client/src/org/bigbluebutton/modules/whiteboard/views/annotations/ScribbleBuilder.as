package org.bigbluebutton.modules.whiteboard.views.annotations
{
	...
	public class ScribbleBuilder implements IBuilder
	{
		...
		public function ScribbleBuilder(wbCanvas:WhiteboardCanvas, sendShapeFrequency:int, shapeFactory:AnnotationDisplayFactory)
		{
			_wbCanvas = wbCanvas;
